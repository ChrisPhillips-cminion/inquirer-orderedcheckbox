...
describe('`orderedCheckbox` prompt', function () {
  beforeEach(function () {
  ...
  it('should allow for arrow navigation - right', function (done) {
    this.checkbox.run().then(function (answer) {
    ...
    this.rl.input.emit('keypress', null, {name: 'down'});
    this.rl.input.emit('keypress', null, {name: 'right'});
    this.rl.input.emit('keypress', ' ', {name: 'space'});
    this.rl.emit('line');
  });
  it('should allow for arrow navigation - left', function (done) {
    this.checkbox.run().then(function (answer) {
    ...
    this.rl.input.emit('keypress', null, {name: 'left'});
    this.rl.input.emit('keypress', null, {name: 'up'});
    this.rl.input.emit('keypress', ' ', {name: 'space'});
    this.rl.emit('line');
  });
  it('should allow for vi-style navigation', function (done) {
    ...
    // this.rl.input.emit('keypress', 'h', {name: 'h'});
    // this.rl.input.emit('keypress', 'l', {name: 'l'});
    this.rl.input.emit('keypress', ' ', {name: 'space'});
    this.rl.emit('line');
  });
